...
This is Implementation of Best Fit strategy used in memory management of computers.
*/
...
// It says that allocate block which leads to least external fragmentation.
void bestfit(struct node **temp1, struct node **temp2, int a)		// This is the First Fit Strategy which is implemented using Linked List.
{
