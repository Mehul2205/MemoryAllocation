...
This is Implementation of First Fit strategy used in memory management of computers.
*/
...
// In the First Fit, the partition which is sufficient from top of Main Memory.
void firstfit(struct node **temp1, struct node **temp2, int a)		// This is the First Fit Strategy which is implemented using Linked List.
{
